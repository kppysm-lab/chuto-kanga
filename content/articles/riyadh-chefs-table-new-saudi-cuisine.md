...
dekEn: Beyond the image of an oil nation, a distinct food culture is now taking shape.
excerpt: 観光開放からわずか数年。リヤドでは伝統食材を現代的な技法で再構築する若手シェフが次々と頭角を現している。その厨房を訪ねた。
excerptEn: Just a few years after opening to tourism, Riyadh's young chefs are
  rapidly rising, reconstructing traditional ingredients through modern
  technique. A visit to their kitchens.
...
bodyEn: >-
  Saudi Arabia opened to tourist visas in 2019. Since then, the food scene in
  the capital Riyadh has been changing at a startling pace. Chefs trained in
  France and Japan are reconstructing home-style dishes like kabsa and jareesh
  using French and modern kaiseki technique.

...
dekEn: What a contemporary art festival on the Red Sea coast is asking.
excerpt: サウジアラビアの現代アートシーンを牽引するジェッダ・ビエンナーレ。地域の若手作家たちが見つめる「アイデンティティ」というテーマを追った。
excerptEn: Jeddah's Biennale has become a driving force in Saudi Arabia's
  contemporary art scene. We followed the theme of "identity" as seen through
  the region's emerging artists.
...
featured: true
bodyEn: >-
  Jeddah, a port city on the Red Sea. In a corner of Al-Balad, the old town's
  stone houses, the Biennale is held inside a converted warehouse of enormous
  scale. Most of the exhibiting artists are under 40, and largely from the Gulf
  region.
